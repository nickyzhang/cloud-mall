...
public interface UserService {
    ...
    @RequestMapping(value = "/user/auth/register",method = RequestMethod.POST)
    ...
    public ResponseResult<UserInfo> find(@PathVariable(value = "userId") Long userId);

    @RequestMapping(value = "/user/auth/sendMailCode",method = RequestMethod.POST)
    public ResponseResult sendMailCode(@RequestParam("email") String email);

    @RequestMapping(value = "/use/authr/sendSmsCode",method = RequestMethod.POST)
    public ResponseResult sendSmsCode(@RequestParam("phone") String phone);

    @RequestMapping(value = "/user/modifyMobile",method = RequestMethod.PUT)
    public ResponseResult modifyMobile(@RequestParam("oldMobile") String oldMobile,
                                       @RequestParam("newMobile") String newMobile);

    @RequestMapping(value = "/user/modifyEmail",method = RequestMethod.PUT)
