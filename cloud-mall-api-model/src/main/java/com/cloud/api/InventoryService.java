...
public interface InventoryService {
    @RequestMapping(value = "/inventory/findBySkuId",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/inventory/deduct/available-stock",method = RequestMethod.POST)
    public ResponseResult preOccupyStock(@RequestParam("skuId") Long skuId, @RequestParam("stockNum") Integer stockNum);

    @RequestMapping(value = "/inventory/deduct/total-stock",method = RequestMethod.POST)
